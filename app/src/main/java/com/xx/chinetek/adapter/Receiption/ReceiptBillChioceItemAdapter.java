package com.xx.chinetek.adapter.Receiption;
...
public class ReceiptBillChioceItemAdapter extends BaseAdapter  {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        listItemView.txtTaskNo.setText(receiptModel.getVoucherNo());
      //  listItemView.txtSupplierName.setText(receiptModel.getSupplierName());
        listItemView.txtERPVoucherNo.setText(receiptModel.getErpVoucherNo());
